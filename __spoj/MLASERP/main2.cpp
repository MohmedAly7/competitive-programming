    ...
    void ins(p t)
{
    ...
    for (int o=0;o<4;o++)
   {
       if (!check(t.i-in[o],t.l-in[o+1])) continue;
...
int main()
{
 ...
 flag[se[0].first][se[0].second]=1;
      for (int o=0;o<4;o++)
      {
       ...
       {
           p tem =arr[se[0].first-in[o]][se[0].second-in[o+1]];
           tem.rood=r[o];
           ready.insert(tem) ;
            coun++;
       }
    ...
    while(ready.size())
    {
        ...
        if (te.cost==mcost[te.i][te.l])
{           cout<<te.i<<te.l<<"**"<<endl;
            ins(te);
}        if (flag[te.i][te.l]) continue;
        ins(te);cout<<te.i<<te.l<<"**"<<endl;
        mcost[te.i][te.l]=te.cost;
    ...
    for (int x =0;x<h;x++)
      ...
      cout<<endl;
        ...
        cout<<mcost[se[1].first][se[1].second]<<endl;
